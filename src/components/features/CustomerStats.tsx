...
import { CustomerStats as CustomerStatsType } from '@/lib/types/customer';
import {
  Users,
  FileText,
  DollarSign,
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-lg font-semibold text-gray-900">توزيع العملاء حسب الجنسية</h3>
      </div>
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-lg font-semibold text-gray-900">التسجيلات الشهرية</h3>
      </div>
      <div className="space-y-3">
