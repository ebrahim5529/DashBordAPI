...
interface DeliveriesTableProps {
  ...
  onAddDelivery: () => void;
  onEditDelivery: (delivery: DeliveryTableData) => void;
  onDeleteDelivery: (delivery: DeliveryTableData) => void;
  onViewDelivery: (delivery: DeliveryTableData) => void;
            ...
            <tbody>
              {data.map((item) => (
                <tr key={item.id} className="border-b hover:bg-gray-50 dark:hover:bg-gray-800">
                  ...
                  <td className="py-3 px-4 text-gray-600 dark:text-gray-400">
                    {formatDate(item.deliveryDate, 'SHORT')}
                  </td>
                  <td className="py-3 px-4 text-gray-600 dark:text-gray-400">
                    {item.itemsCount}
                  </td>
